import {Apis, Manager} from "dxpertsjs-ws";
...
class RouterTransitioner {
    ...
    /**
     *
     * @param apiNodeUrl the url of the target node, e.g. wss://eu.nodes.dxperts.ws
...
class Pinger {
    /**
     * @param connectionManager dxpertsjs connectionmanager
