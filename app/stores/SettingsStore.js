...
const CORE_ASSET = "DXP"; // Setting this to DXP to prevent loading issues when used with DXP chain which is the most usual case currently
...
class SettingsStore {
    ...
    init() {
        return new Promise(resolve => {
            ...
            let coreAssets = {
                markets_4018d784: "DXP",
                markets_39f5e2ed: "TEST"
            };
            let coreAsset = coreAssets[this.starredKey] || "DXP";
            /*
