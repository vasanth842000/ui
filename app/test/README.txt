...
dbg_make_uia matrix TEST
dbg_make_uia matrix MORE
issue_token matrix 2323231232 TEST "" true
issue_token matrix 2323231232 MORE "" true
...
sell_token ACCOUNT_ID AMOUNT ASSET FOR_AMOUNT FOR_ASSET EXPIRATION fill_or_kill broadcast
ex: sell_token 1.2.15 1000 CORE 100 USD 100000 false true

Place a short order:

short_sell_token ACCOUNT_ID SHORT_AMOUNT ASSET_NAME COLLATERAL_AMOUNT broadcast
ex: short_sell_token 1.2.15 1000 USD 1000 true
...
var trx = ["asset_update_smarttoken", {"issuer":"1.2.15","asset_to_update":"1.3.1","new_options":{"feed_lifetime_sec":55,"force_settlement_delay_sec":0,"force_settlement_offset_percent":0,"maximum_force_settlement_volume":0,"short_backing_asset":"1.3.0"}}]
...
var trx = ["account_update", {"account": "1.2.15", "num_blockproducer":0,"num_dxpcore":0, "vote": ["0:18"]}]
