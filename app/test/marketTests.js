...
const asset2 = {asset_id: "1.3.121", precision: 4}; // dUSD
const asset3 = {asset_id: "1.3.113", precision: 4}; // dCNY
...
describe("Asset", function() {
    ...
    it("Can be multiplied with a price", function() {
        ...
        // 100 DXP * 200 DXP/USD = 100 DXP * (1/200) USD/DXP = 0.5 USD
        assert.equal(
...
describe("Settle Order", function() {
    ...
    const smarttoken_options = {force_settlement_offset_percent: 150};

    it("Instantiates", function() {
        new SettleOrder(so, assets, "1.3.0", settlePrice_0, smarttoken_options);
    });
