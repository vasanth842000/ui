...
import {BodyClassName, Notification} from "dxperts-ui-style-guide";
...
const CreateBenefactor = Loadable({
    loader: () =>
        import(
            /* webpackChunkName: "create-benefactor" */ "./components/Account/CreateBenefactor"
        ),
    loading: LoadingIndicator
});
                    ...
                    <div id="mainContainer" className="grid-block">
                        <div className="grid-block vertical">
                            <Switch>
                                ...
                                <Route
                                    path="/create-benefactor"
                                    component={CreateBenefactor}
                                />
