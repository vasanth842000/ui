...
import {Alert, Icon} from "dxperts-ui-style-guide";
import {Carousel} from "antd";
import SettingsActions from "actions/SettingsActions";
import {connect} from "alt-react";
import SettingsStore from "stores/SettingsStore";
import {hash} from "dxpertsjs";
...
class NewsHeadline extends React.Component {
    ...
    getNewsFromGitHub() {
        fetch(
            "https://gitlab.com/Robertz0/dxperts-ui-web/contents/news.json?ref=news_feed_on_the_very_top"
        )
            .then(res => {
                return res.json();
            })
