...
import {Input, Tooltip} from "dxperts-ui-style-guide";
...
class MarketsTable extends React.Component {
    ...
    getTableData(row) {
        ...
        const imageSrc = this.state.imgError
            ...
            : `${__BASE_URL__}asset-symbols/dxp.png`;
        ...
        const marketRows = markets
            ...
            .map(row => {
                ...
                if (row.isHidden !== this.state.showHidden) {
                    ...
                    const {isSmartToken: quoteIsSmartToken} = utils.replaceName(
                        quoteObject
                    );
                    const {isSmartToken: baseIsSmartToken} = utils.replaceName(
                        baseObject
                    );
