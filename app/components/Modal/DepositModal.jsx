...
class DepositModalContent extends DecimalChecker {
    ...
    _setDepositAsset(asset) {
        ...
        if (usingGateway) {
            ...
            this.setState({selectedAsset: "DXP"});
        }
    }
    ...
    _getDepositAddress(selectedAsset, selectedGateway) {
        ...
        if (
            ...
            let memoText;
            if (!!backingAsset.memoType && backingAsset.memoType === "dxpid") {
                let accountMap = ChainStore.getAccount(account, false);
                memoText =
                    gatewayStatus[selectedGateway].fixedMemo["prepend_dxpid"] +
    ...
    render() {
        ...
        if (selectedGateway == null && selectedAsset == "DXP") {
            usingGateway = false;
                ...
                <div className="modal__body" style={{paddingTop: "0"}}>
                    ...
                    {!usingGateway ? (
                        <div className="container-row deposit-directly">
                            ...
                            <Translate
                                component="h6"
                                content="modal.deposit.dxp_transfer_description"
                            />
                        </div>
                    ) : null}
                </div>
