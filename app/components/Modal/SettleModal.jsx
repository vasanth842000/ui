...
import {Alert, Form, Modal, Button, Tooltip} from "dxperts-ui-style-guide";
...
class ModalContent extends React.Component {
    ...
    getSettlementInfo() {
        ...
        const maintenanceInterval =
            core && core.size
                ...
                : 0;
        const smartToken = asset.get("smarttoken").toJS();
        const currentSettled = smartToken.force_settled_volume;
        const maxSettlementVolume =
            currentSupply *
            (smartToken.options.maximum_force_settlement_volume / 10000);
        const remainingVolume = !currentSettled
            ? maxSettlementVolume
            : maxSettlementVolume - currentSettled;
        const settlementDelay = smartToken.options.force_settlement_delay_sec;
        return {
            maxSettlementVolume,
            remainingVolume,
            maintenanceInterval,
    ...
    render() {
        ...
        let isGlobalSettled =
            asset.get("smarttoken").get("settlement_fund") > 0 ? true : false;
        ...
        // var maxSettlementVolume = asset.get("smarttoken").get("options").get("maximum_force_settlement_volume");
        // var currentSettled = asset.get("smarttoken").get("force_settled_volume");
