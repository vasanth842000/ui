...
import {Button, Select, Popover, Tooltip} from "dxperts-ui-style-guide";
...
class BuySell extends React.Component {
    ...
    render() {
        ...
        const isSmartToken = !!otherAsset.get("smarttoken");
        // check if globally settled
        const isGloballySettled =
            isSmartToken &&
            otherAsset.get("smarttoken").get("settlement_fund") > 0;
