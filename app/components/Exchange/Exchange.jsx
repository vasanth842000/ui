...
import {ChainStore, FetchChain} from "dxpertsjs";
import {
    Tabs,
    Collapse,
    Icon as AntIcon,
...
class Exchange extends React.Component {
    ...
    _getSettlementInfo() {
        ...
        return !!(
            showCallLimit &&
            lowestCallPrice &&
            !quoteAsset.getIn(["smarttoken", "is_prediction_market"])
        );
    }
    ...
    render() {
        ...
        let quoteIsSmartToken = quoteAsset.get("smarttoken_data_id")
            ? true
            : false;
        let baseIsSmartToken = baseAsset.get("smarttoken_data_id")
            ? true
            : false;
        ...
        // Decimals
        let hasPrediction =
            base.getIn(["smarttoken", "is_prediction_market"]) ||
            quote.getIn(["smarttoken", "is_prediction_market"]);
