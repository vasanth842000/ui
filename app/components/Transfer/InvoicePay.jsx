...
import {ChainStore, FetchChain, FetchChainObjects} from "dxpertsjs/es";
...
import {Button, Row, Col, Icon, Tooltip, Switch} from "dxperts-ui-style-guide";
    ...
    render() {
        ...
        if (this.state.invoiceQr) {
            ...
            if (
                ...
                qrcode =
                    `dxperts:operation/transfer?to=${invoice.to}&from=${this.state.pay_from_name}&asset=${asset}&amount=${total_amount}` +
