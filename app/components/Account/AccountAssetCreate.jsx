...
import {ChainStore, ChainValidation} from "dxpertsjs";
...
import {Switch} from "dxperts-ui-style-guide";

let GRAPHENE_MAX_SHARE_SUPPLY = new big(
    assetConstants.GRAPHENE_MAX_SHARE_SUPPLY
);

class SmartTokenOptions extends React.Component {
    static propTypes = {
    ...
    _onFoundBackingAsset(asset) {
        if (asset) {
            ...
            } else if (!asset.getIn(["smarttoken", "is_prediction_market"])) {
                if (
    ...
    render() {
        let {smarttoken_opts} = this.props;
        ...
        return (
            <div className="small-12 grid-content">
                <label>
                    ...
                    <input
                        type="number"
                        value={smarttoken_opts.feed_lifetime_sec / 60}
                ...
                <label>
                    ...
                    <input
                        type="number"
                        value={smarttoken_opts.minimum_feeds}
                        onChange={this.props.onUpdate.bind(
                            this,
                            "minimum_feeds"
                        )}
                ...
                <label>
                    ...
                    <input
                        type="number"
                        value={smarttoken_opts.force_settlement_delay_sec / 60}
                        onChange={this.props.onUpdate.bind(
                            this,
...
SmartTokenOptions = BindToChainState(SmartTokenOptions);
...
class AccountAssetCreate extends React.Component {
    ...
    resetState(props) {
        ...
        let isSmartToken = false;
        let precision = utils.get_token_precision(4);
        ...
        // let permissions = assetUtils.getPermissions(permissionBooleans, isSmartToken);
    ...
    _getPermissions(state) {
        let flagBooleans = assetUtils.getFlagBooleans(0, state.isSmartToken);
    ...
    _createAsset(e) {
        ...
        let flags = assetUtils.getFlags(flagBooleans, isSmartToken);
    ...
    onChangeSmartTokenOpts(value, e) {
        let {smarttoken_opts, errors} = this.state;

        switch (value) {
            case "force_settlement_offset_percent":
            case "maximum_force_settlement_volume":
                smarttoken_opts[value] =
                    parseFloat(e.target.value) *
                    assetConstants.GRAPHENE_1_PERCENT;
                break;
            case "minimum_feeds":
                smarttoken_opts[value] = parseInt(e.target.value, 10);
                break;
            ...
            case "force_settlement_delay_sec":
                ...
                smarttoken_opts[value] = parseInt(
            ...
            case "short_backing_asset":
                smarttoken_opts[value] = e;
                break;

            case "invalid":
                errors.invalid_smarttoken = e;
                break;

            default:
                smarttoken_opts[value] = e.target.value;
                break;
        }

        let isValid =
            !errors.symbol && !errors.max_supply && !errors.invalid_smarttoken;
    ...
    _onUpdateInput(value, e) {
        ...
        let precision = utils.get_token_precision(this.state.update.precision);
    ...
    _onToggleSmartToken() {
        let {update} = this.state;
        this.state.isSmartToken = !this.state.isSmartToken;
        if (!this.state.isSmartToken) {
    ...
    render() {
        ...
        const confirmButtons = (
            <div>
                ...
                >
                    <Translate content="header.create_token" />
                </button>
            </div>
        );
                ...
                <div className="content-block small-12">
                    <div className="tabs-container generic-bordered-box">
                        ...
                        >
                                    ...
                                    >
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style={{border: "none"}}>
                                                    <Switch
                                                        checked={isSmartToken}
                                                        onChange={this._onToggleSmartToken.bind(
                                                            this
                                                        )}
                                                    />
                                                </td>
                                        ...
                                        <div>
                                            <h5>
                                                ...
                                                <span>
                                                    :{" "}
                                                    {utils.format_number(
                                                        utils.get_token_price(
                                                            core_exchange_rate
                                                                .quote.amount *
                                                                utils.get_token_precision(
                                                                    update.precision
                                                                ),
                                                            {
                                                                precision:
                            ...
                            {isSmartToken ? (
                                <Tab title="account.user_issued_assets.smarttoken_opts">
                                    <SmartTokenOptions
                                        smarttoken_opts={smarttoken_opts}
                                        onUpdate={this.onChangeSmartTokenOpts.bind(
                                            this
                                        )}
                                        backingAsset={
...
export {AccountAssetCreate, SmartTokenOptions};
