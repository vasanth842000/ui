...
class ListGenerator extends React.Component {
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        if (
            prevState == null ||
            prevState.assetsPropsCount != nextProps.smartTokens.length ||
            prevState.ordersJson != callOrdersJson
        ) {
            let assets = new Array();
            // construct map of smarttokens
            let assetsMap = {};
            // index to track asset info
            let index = 0;

            nextProps.smartTokens.forEach(o => {
            ...
            return {
                assetsPropsCount: nextProps.smartTokens.length,
                assets: assets,
