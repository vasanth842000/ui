...
class MarginPosition extends React.Component {
    ...
    _getCollateralRatio() {
        ...
        const c = utils.get_token_amount(
            co.collateral,
            this.props.collateralAsset
        );
        const d = utils.get_token_amount(co.debt, this.props.debtAsset);
    ...
    render() {
        ...
        let {isSmartToken} = utils.replaceName(this.props.debtAsset);

        let isPrediction =
            debtAsset.get("smarttoken") &&
            debtAsset.getIn(["smarttoken", "is_prediction_market"]);
