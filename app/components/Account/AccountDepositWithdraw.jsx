...
import XdxpxGateway from "../DepositWithdraw/xbtsx/XbtsxGateway";
...
class AccountDepositWithdraw extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            xdxpxService: props.viewSettings.get("xdxpxService", "gateway"),
    ...
    shouldComponentUpdate(nextProps, nextState) {
        return (
            ...
            nextState.xdxpxService !== this.state.xdxpxService ||
    ...
    toggleXdxpxService(service) {
        this.setState({
            xdxpxService: service
        });
            ...
            template: (
                <div className="content-block">
                    ...
                    >
                        <ul className="button-group segmented no-margin">
                            <li
                                onClick={this.toggleXdxpxService.bind(
                                    this,
                                    "gateway"
                                )}
                                className={
                                    xdxpxService === "gateway"
                                        ? "is-active"
                                        : ""
                                }
                            >
                    ...
                    {xdxpxService === "gateway" && xdxpxGatewayCoins.length ? (
                        <XdxpxGateway
                            account={account}
                            coins={xdxpxGatewayCoins}
                        />
                    ) : null}

                    {xdxpxService === "fiat" ? (
                        <div>
                            <Translate content="gateway.xdxpx.coming_soon" />
                        </div>
                    ) : null}
                </div>
            )
                ...
                <div>
                    <div className="content-block">
                        ...
                        >
                            <ul className="button-group segmented no-margin">
                                <li
                                    onClick={this.toggleDXPervice.bind(
                                        this,
                                        "bridge"
                                    )}
                                    className={
                        ...
                        <BlockTradesBridgeDepositRequest
                            ...
                            initial_deposit_output_coin_type="dxp"
                            initial_deposit_estimated_input_amount="1.0"
                            initial_withdraw_input_coin_type="dxp"
                            initial_withdraw_output_coin_type="btc"
                            initial_withdraw_estimated_input_amount="100000"
                            initial_conversion_input_coin_type="dxp"
                            initial_conversion_output_coin_type="dbtc"
    ...
    render() {
        ...
        let xdxpxGatewayCoins = this.props.xdxpxBackedCoins
            .map(coin => {
                return coin;
            })
            .sort((a, b) => {
...
export default connect(DepositStoreWrapper, {
    ...
    getProps() {
        return {
            ...
            xdxpxBackedCoins: GatewayStore.getState().backedCoins.get(
                "XDXPX",
                []
            ),
