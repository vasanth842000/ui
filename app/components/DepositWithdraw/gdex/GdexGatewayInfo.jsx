...
class GdexGatewayInfo extends React.Component {
    ...
    render() {
        ...
        if (
            ...
            return emptyRow;
        const {coin, dxpCoin} = this.props;
        // asset is not loaded
        if (!dxpCoin) return emptyRow;
        ...
        if (account_balances_object)
            balance = account_balances_object.toJS()[dxpCoin.get("id")];
