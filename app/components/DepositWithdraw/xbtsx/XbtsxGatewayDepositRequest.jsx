...
import {ChainStore} from "dxpertsjs/es";
import ChainTypes from "components/Utility/ChainTypes";
import BindToChainState from "components/Utility/BindToChainState";
import XdxpxWithdrawModal from "./XbtsxWithdrawModal";
import AccountBalance from "../../Account/AccountBalance";
import XdxpxDepositAddressCache from "lib/common/XbtsxDepositAddressCache";
...
import {Modal} from "dxperts-ui-style-guide";

class XdxpxGatewayDepositRequest extends React.Component {
    static propTypes = {
    ...
    constructor(props) {
        super(props);
        this.deposit_address_cache = new XdxpxDepositAddressCache();
    ...
    render() {
        ...
        let minDeposit = utils.format_number(
            this.props.min_amount /
                utils.get_token_precision(this.props.asset_precision),
                ...
                <div className="rudex__gateway grid-block no-padding no-margin">
                    ...
                    <div className="small-12 medium-7">
                        ...
                        <label className="left-label">
                            <b>
                                <Translate
                                    content="gateway.xdxpx.min_amount"
...
export default BindToChainState(XdxpxGatewayDepositRequest, {
    keep_updating: true
});
