...
import {Button, Modal} from "dxperts-ui-style-guide";
import PropTypes from "prop-types";

class XdxpxWithdrawModal extends React.Component {
    static propTypes = {
    ...
    onSubmitConfirmation() {
        ...
        let asset = this.props.asset;
        let precision = utils.get_token_precision(asset.get("precision"));
                    ...
                    <div className="content-block">
                        ...
                        {this.state.minAmountError ? (
                            <p
                                ...
                                style={{paddingTop: 10}}
                            >
                                <Translate content="gateway.xdxpx.min_amount_error" />
                            </p>
                        ) : null}
...
XdxpxWithdrawModal = BindToChainState(XdxpxWithdrawModal);

export default connect(XdxpxWithdrawModal, {
    listenTo() {
