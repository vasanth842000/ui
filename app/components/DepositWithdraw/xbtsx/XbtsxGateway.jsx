...
import XdxpxGatewayDepositRequest from "./XbtsxGatewayDepositRequest";
...
class XdxpxGateway extends React.Component {
    constructor(props) {
        super();

        this.state = {
            activeCoin: this._getActiveCoin(props, {action: "deposit"}),
            action: props.viewSettings.get(`xdxpxAction`, "deposit")
        };
    }

    _getActiveCoin(props, state) {
        let cachedCoin = props.viewSettings.get(
            `activeCoin_xdxpx_${state.action}`,
            null
        );
    ...
    onSelectCoin(e) {
        ...
        let setting = {};
        setting[`activeCoin_xdxpx_${this.state.action}`] = e.target.value;
    ...
    changeAction(type) {
        ...
        SettingsActions.changeViewSetting({[`xdxpxAction`]: type});
    }
    ...
    render() {
        ...
        let supportUrl = "https://t.me/xdxpio";
                ...
                <div className="grid-block no-margin vertical medium-horizontal no-padding">
                    <div className="medium-4">
                        <div>
                            ...
                            <select
                                className="external-coin-types dxp-select"
                ...
                {!coin ? null : (
                    <div>
                        <div style={{marginBottom: 15}}>
                            ...
                            <div>
                                <Translate content="gateway.xdxpx.support_block" />
                                <br />
                                <br />
                                <a
                                    href={supportUrl}
...
export default connect(XdxpxGateway, {
    listenTo() {
