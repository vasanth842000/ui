        ...
        getConversionJson(this.props, userAccessToken)
            .then(json => {
                ...
                if (
                    ...
                    // let precision = utils.get_token_precision(this.props.asset.get("precision"));
    ...
    urlConnection(checkUrl, state_coin_info) {
        ...
        Promise.all([
            ...
            .then(json_responses => {
                ...
                let allowed_mappings_for_deposit = {}; // all non-dxp to dxp
                let allowed_mappings_for_withdraw = {}; // all dxp to non-dxp
                let allowed_mappings_for_conversion = {}; // all dxp to dxp
                trading_pairs.forEach(pair => {
                    ...
                    if (
                        ...
                        if (
                            ...
                            if (
                                input_coin_info.walletType != "dxperts" &&
                                output_coin_info.walletType == "dxperts"
                            ) {
