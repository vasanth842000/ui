...
import {Icon as AntIcon} from "dxperts-ui-style-guide";
                ...
                case "account_update":
                    ...
                    if (op[1].new_options) {
                        if (op[1].new_options.voting_account) {
                            ...
                            console.log(
                                "num blockproducers: ",
                                op[1].new_options.num_blockproducer
                            );
                            console.log(
                                "===============> NEW: ",
                                op[1].new_options
                            ...
                            rows.push(
                                <tr key={key++}>
                                    <td>
                                        <Translate
                                            component="span"
                                            content="account.options.num_dxpcore"
                                        />
                                    </td>
                                    <td>{op[1].new_options.num_dxpcore}</td>
                                </tr>
                            );
                            rows.push(
                                <tr key={key++}>
                                    <td>
                                        <Translate
                                            component="span"
                                            content="account.options.num_blockproducers"
                                        />
                                    </td>
                                    <td>
                                        {op[1].new_options.num_blockproducer}
                    ...
                    rows.push(
                        <tr key={key++}>
                            <td>
                                <Translate
                                    component="span"
                                    content="explorer.dxpcore_member.title"
                                />
                            </td>
                            <td>
                                {this.linkToAccount(
                                    op[1].dxpcore_member_account
                                )}
                            </td>
                        </tr>
                    );
                    ...
                    rows.push(
                        <tr key={key++}>
                            <td>
                                <Translate
                                    component="span"
                                    content="explorer.block.blockproducer"
                                />
                            </td>
                            <td>
                                {this.linkToAccount(
                                    op[1].blockproducer_account
                                )}
                            </td>
                        </tr>
                    );
                    ...
                    rows.push(
                        <tr key={key++}>
                            <td>
                                <Translate
                                    component="span"
                                    content="explorer.benefactors.title"
                                />
                            </td>
                            <td>{op[1].name}</td>
                        </tr>
                    ...
                    rows.push(
                        <tr key={key++}>
                            <td>
                                <Translate
                                    component="span"
                                    content="explorer.benefactors.daily_pay"
                                />
                            </td>
                            <td>
                                <FormattedAsset
                    ...
                    rows.push(
                        <tr key={key++}>
                            <td>
                                <Translate
                                    component="span"
                                    content="explorer.benefactors.website"
                                />
                            </td>
                        ...
                        rows.push(
                            <tr key={key++}>
                                <td>
                                    <Translate
                                        component="span"
                                        content="explorer.benefactors.vesting_pay"
                                    />
                                </td>
                                <td>
                                    {
