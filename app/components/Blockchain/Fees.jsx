...
import {ChainStore, ChainTypes as grapheneChainTypes} from "dxpertsjs";
import {Card} from "dxperts-ui-style-guide";
...
class FeeGroup extends React.Component {
    ...
    render() {
        ...
        let fees = opIds.map(opID => {
            ...
            if (opId === 10) {
                // See dxperts.gvxlive.io-ui/issues/996
