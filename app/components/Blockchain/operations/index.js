...
import {BlockproducerCreate} from "./BlockproducerCreate";
import {BlockproducerUpdate} from "./BlockproducerUpdate";
import {BlockproducerWithdrawPay} from "./BlockproducerWithdrawPay";
...
import {BenefactorCreate} from "./BenefactorCreate";
import {BalanceClaim} from "./BalanceClaim";
import {CommittyMemberCreate} from "./DxpcoreMemberCreate";
...
import {DxpcoreMemberUpdateGlobalParams} from "./DxpcoreMemberUpdateGlobalParams";
...
export default function opComponents(opType, props, opts) {
    switch (opType) {
        ...
        case "blockproducer_create":
            return <BlockproducerCreate {...props} {...opts} />;

        case "blockproducer_update":
            return <BlockproducerUpdate {...props} {...opts} />;

        case "blockproducer_withdraw_pay":
            return <BlockproducerWithdrawPay {...props} {...opts} />;
        ...
        case "benefactor_create":
            return <BenefactorCreate {...props} {...opts} />;

        case "balance_claim":
            return <BalanceClaim {...props} {...opts} />;

        case "dxpcore_member_create":
        ...
        case "dxpcore_member_update_global_parameters":
            return (
                <DxpcoreMemberUpdateGlobalParams
