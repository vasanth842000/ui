...
import {ChainTypes as grapheneChainTypes, ChainStore} from "dxpertsjs";
        ...
        switch (
                ...
                if (current === op[1].blockproducer_account) {
                    column = (
                        <span>
                            ...
                            />
                            &nbsp;
                            {this.linkToAccount(op[1].blockproducer_account)}
                        </span>
                    );
                } else {
                    column = (
            ...
            case "benefactor_create":
                column = (
                    <span>
                        <TranslateWithLinks
                            string="operation.benefactor_create"
                            keys={[
                                {
                                    type: "account",
                                    value: op[1].owner,
            ...
            case "dxpcore_member_create":
                column = (
                    <span>
                        <Translate
                            component="span"
                            content="transaction.dxpcore_member_create"
                        />
                        &nbsp;
                        {this.linkToAccount(op[1].dxpcore_member_account)}
                    </span>
                );
                break;
            ...
            case "dxpcore_member_update_global_parameters":
                console.log("dxpcore_member_update_global_parameters op:", op);
                column = (
                    <span>
                        <TranslateWithLinks
                            string="operation.dxpcore_member_update_global_parameters"
                            keys={[
                                {
                                    type: "account",
                                    value: "1.2.0",
