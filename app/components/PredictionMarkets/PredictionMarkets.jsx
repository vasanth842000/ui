...
import {Switch, Button, Radio, Icon, Tooltip} from "dxperts-ui-style-guide";
...
class PredictionMarkets extends Component {
    ...
    onResolveMarket = market => {
        ...
        let quote = new Asset({
            ...
            asset_id: asset.smarttoken.options.short_backing_asset,
    ...
    _filterMarkets() {
        ...
        const markets = this.props.predictionMarkets.filter(assetInfo => {
            ...
            const smarttokenData =
                asset.smarttoken_data || asset.smarttoken || {};
            if (
                ...
                if (filter && filter !== "all") {
                    ...
                    const settlementFund = smarttokenData.settlement_fund || 0;
