...
export default class CreateMarketModal extends Modal {
    ...
    _getPermissionsAndFlags() {
        let flagBooleans = assetUtils.getFlagBooleans(0, IS_SMARTTOKEN);
        ...
        let flags = assetUtils.getFlags(flagBooleans, IS_SMARTTOKEN);
        return {
            flags,
    ...
    _createAsset() {
        let {marketOptions, core_exchange_rate, smarttoken_opts} = this.state;
