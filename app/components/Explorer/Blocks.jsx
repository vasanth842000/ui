...
import LinkToBlockproducerById from "../Utility/LinkToBlockproducerById";
                    ...
                    <div className="grid-block text-center small-6 medium-3">
                        <div className="grid-content no-overflow clear-fix">
                            <span className="txtlabel">
                                <Translate
                                    component="span"
                                    content="explorer.blocks.active_blockproducers"
                                />
                            </span>
                            <h2 className="txtlabel success">
                                {globalObject.get("active_blockproducers").size}
                            </h2>
                        </div>
                    </div>
                    ...
                    <div className="grid-block text-center small-6 medium-3">
                        <div className="grid-content no-overflow clear-fix">
                            <span className="txtlabel">
                                <Translate
                                    component="span"
                                    content="explorer.blocks.active_dxpcore_members"
                                />
                            </span>
                            <h2 className="txtlabel success">
                                {
                                    globalObject.get("active_dxpcore_members")
                                        .size
                                }
                            </h2>
                        </div>
