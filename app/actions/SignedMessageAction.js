...
import {Signature, ChainStore, PublicKey} from "dxpertsjs";
import WalletUnlockActions from "actions/WalletUnlockActions";
import WalletDb from "stores/WalletDb";

const MSG_HEAD = "-----BEGIN DXPERTS SIGNED MESSAGE-----";
const MSG_META = "-----BEGIN META-----";
const MSG_SIGNATURE = "-----BEGIN SIGNATURE-----";
const MSG_FOOT = "-----END DXPERTS SIGNED MESSAGE-----";
...
class SignedMessageAction {
     ...
     *                      block : Current last irreversible block of the dxperts blockchain
