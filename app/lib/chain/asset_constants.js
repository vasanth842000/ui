module.exports = {
    permission_flags: {
        ...
        global_settle: 0x20 /**< allow the smarttoken issuer to force a global settling -- this may be set in permissions, but not flags */,
        disable_confidential: 0x40 /**< allow the asset to be used with confidential transactions */,
        blockproducer_fed_asset: 0x80 /**< allow the asset to be fed by blockproducers */,
        dxpcore_fed_asset: 0x100 /**< allow the asset to be fed by the dxpcore */
    },
    uia_permission_mask: [
        "charge_market_fee",
        "white_list",
...
const static uint32_t ASSET_ISSUER_PERMISSION_MASK = charge_market_fee|white_list|override_authority|transfer_restricted|disable_force_settle|global_settle|disable_confidential
      |blockproducer_fed_asset|dxpcore_fed_asset;
