...
class CallOrder {
    constructor(
         ...
         * Since dxperts-core 3.0.0 this is no longer done by the blockproducer_node.
    ...
    _getMaxCollateralToSell() {
        /*
        BSIP38: https://gitlab.com/dxperts/bsips/blob/master/bsip-0038.md
    ...
    /*
     * Assume a USD:DXP market
     * The call order will always be selling DXP in order to buy USD
    ...
    getStatus() {
        const mr =
            this.assets[this.debt_id].smarttoken.current_feed
...
class SettleOrder extends LimitOrder {
    constructor(order, assets, market_base, feed_price, smarttoken_options) {
        if (!feed_price || !smarttoken_options) {
            throw new Error(
                "SettleOrder needs feed_price and smarttoken_options inputs"
            );
        }
        ...
        this.offset_percent =
            smarttoken_options.force_settlement_offset_percent;
